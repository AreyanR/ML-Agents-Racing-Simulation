...
public class Runner1Agent : Agent
{
    [Header("Walk Speed")]
    [Range(0.1f, 10)]
    [SerializeField]
    ...
    public Runner2Agent runner2; // Reference to Runner2 agent
    ...
    public static bool raceFinished = false; // Shared static variable to track if the race is over
    ...
    {
        raceFinished = false; // Reset the race state for each new episode
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(runner2.transform.localPosition); // Add Runner2 position
    }
